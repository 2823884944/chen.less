package cn.c.basics.code;

import cn.c.basics.code.bean.Entity;
...
public class MyBatisPlusCodeUtils {
    ...
    private static final String entityPackage = "cn.c.test.entity";

    @ApiModelProperty(value = "dao对应包")
    private static final String daoPackage = "cn.c.test.mapper";

    @ApiModelProperty(value = "service对应包")
    private static final String servicePackage = "cn.c.test.service";

    @ApiModelProperty(value = "serviceImpl对应包")
    private static final String serviceImplPackage = "cn.c.test.serviceimpl";

    @ApiModelProperty(value = "controller对应包")
    private static final String controllerPackage = "cn.c.test.controller";
    ...
    public static String camel2Underline(String camelContext) {
        if (CsxNullUtils.isNull(camelContext)) {
            return "";
        }
    ...
    public static String name(String classTitle, boolean isFirstUpper){
        if(CsxNullUtils.isNull(classTitle)){
            throw new CsxException("类名的长度必须是正数");
        }
