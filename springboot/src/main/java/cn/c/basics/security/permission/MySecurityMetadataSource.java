package cn.c.basics.security.permission;
...
public class MySecurityMetadataSource implements FilterInvocationSecurityMetadataSource {
    ...
    public void loadResourceDefine() {
        ...
        for(Permission permission : permissions) {
            if(!CsxNullUtils.isNull(permission.getTitle()) && !CsxNullUtils.isNull(permission.getPath())){
    ...
    public Collection<ConfigAttribute> getAttributes(Object object) throws IllegalArgumentException {
        ...
        while (iteratorAttributes.hasNext()) {
            ...
            if (!CsxNullUtils.isNull(iteratorAttributesString) && pathMatcher.match(iteratorAttributesString, filterInvocation.getRequestUrl())) {
