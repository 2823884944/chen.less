...
<div class="login">
    <Row justify="center" align="middle" @keydown.enter.native="submitLogin" style="height:100%">
        <div class="loginUp">
            <div class="loginLeft">
              <img src="../assets/login/tubiao.png" alt="" >
                ...
                <div class="loginRight">
                    <Row class="loginRow">
                        <Tabs v-model="tabName" @on-click="changeTabName" class="loginTab">
                            <TabPane label="用户登陆" name="userAndPassword"  >
                                <Form ref="usernameLoginForm" :model="form" :rules="usernameLoginFormRules" class="form">
                                    <FormItem prop="username" class="loginInput">
                                        <Row>
                                            <Input v-model="form.username" size="large" clearable placeholder="用户名" autocomplete="off">
                                ...
                                <Row type="flex" justify="space-between" align="middle">
                                    ...
                                    <router-link to="/regist">
                                        <a class="forget-pass">没有账号？点击注册</a>
                                    </router-link>
                                </Row>
                                <Row>
