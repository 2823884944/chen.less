...
public class PageUtil {
    ...
    public static Pageable initPage(PageVo page){
        ...
        if(!CsxNullUtils.isNull(sort)) {
            Sort.Direction direction = CsxNullUtils.isNull(order) ? Sort.Direction.DESC : Sort.Direction.valueOf(order.toUpperCase());
    ...
    public static String camel2Underline(String underlineContent) {
        if (CsxNullUtils.isNull(underlineContent)) {
            return NULL_STR;
        }
