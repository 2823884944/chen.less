...
<div class="own-space">
    <Card>
        ...
        <Form ref="userForm" :model="userForm" :label-width="90" label-position="left">
            ...
            <Row :gutter="16">
                ...
                <Col :span="12">
                <FormItem label="所属组织" prop="departmentTitle">
            ...
            <Row :gutter="16">
                <Col :span="12">
                <FormItem label="所在地区" prop="username">
            ...
            <Row :gutter="16">
                <Col :span="12">
                <FormItem label="出生日期" prop="username">
    ...
    <Card>
        <Row :gutter="20">
            ...
            <Row :gutter="16">
                <div class="desc">在下面选择菜单完成添加</div>
        ...
        addMenuFx() {
            ...
            if (size > 0) {
                ...
                for (var i = 1; i < size; i++) {
                    str += "666" + this.addMenuTempList[i].name;
                }
            }
            setMyDoorList({
                str: str
