...
<div>
    <div style="display:flex;">
        ...
        <Poptip transfer trigger="click" placement="right" title="选择组织" width="250">
            <Button icon="md-list">选择组织</Button>
            <div slot="content">
                <Input v-model="searchKey" suffix="ios-search" @on-change="searchDep" placeholder="输入组织名搜索" clearable />
